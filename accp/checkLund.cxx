...
int checkLund(){
  ...
  TH2D *h_el_gen_w_theta = new TH2D("h_el_gen_w_theta","h_el_gen_w_theta",100, 0.9, 2.9, 100, 7.0, 60);  
  TH1D *h_el_w = new TH1D(Form("h_el_w_f%d",el_fract),Form("h_el_w_f%d",el_fract),100, 0.9, 1.9);
  ...
  while( ff < f_max ){
    ...
    infile.open(Form("/work/clas12/bclary/CLAS12/electron_studies/elastic/lund_norad/elastic_norad_fraction1/clas12_2GeV_%d.lund",ff));
